...
dataset.asthma = has_prior_event(codelists.asthma)
dataset.chronic_cardiac_disease = has_prior_event(codelists.chronic_cardiac_disease)
dataset.chronic_liver_disease = has_prior_event(codelists.chronic_liver_disease)
dataset.chronic_respiratory_disease = has_prior_event(codelists.chronic_respiratory_disease)
dataset.other_neuro = has_prior_event(codelists.other_neuro)
dataset.stroke_gp = has_prior_event(codelists.stroke_gp)
dataset.dementia = has_prior_event(codelists.dementia)
dataset.ra_sle_psoriasis = has_prior_event(codelists.ra_sle_psoriasis)
dataset.psychosis_schizophrenia_bipolar = has_prior_event(codelists.psychosis_schizophrenia_bipolar)
dataset.permanent_immune = has_prior_event(codelists.permanent_immune)
dataset.temp_immune = has_prior_event(codelists.temp_immune)
...
binary_asthma = has_prior_event_numeric(codelists.asthma)
binary_chronic_cardiac_disease = has_prior_event_numeric(codelists.chronic_cardiac_disease)
binary_chronic_liver_disease = has_prior_event_numeric(codelists.chronic_liver_disease)
binary_chronic_respiratory_disease = has_prior_event_numeric(codelists.chronic_respiratory_disease)
binary_other_neuro = has_prior_event_numeric(codelists.other_neuro)
binary_stroke_gp = has_prior_event_numeric(codelists.stroke_gp)
binary_dementia = has_prior_event_numeric(codelists.dementia)
binary_ra_sle_psoriasis = has_prior_event_numeric(codelists.ra_sle_psoriasis)
binary_psychosis_schizophrenia_bipolar = has_prior_event_numeric(codelists.psychosis_schizophrenia_bipolar)
binary_permanent_immune = has_prior_event_numeric(codelists.permanent_immune)
binary_temp_immune = has_prior_event_numeric(codelists.temp_immune)
